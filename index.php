                                                        ...
                                                        <div class="clearfix image-product relative animate-default">
                                                            ...
                                                            <ul class="option-product animate-default">
                                                                <?php if ($userlogin) { ?>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <li class="relative"><a class="addCart" data-id="<?php echo $hp_getitm1['itmid']; ?>" href="javascript:void(0)"><i class="data-icon data-icon-ecommerce icon-ecommerce-bag"></i></a></li>
                                                                    <?php } ?>
                                            ...
                                            <?php foreach ($hp_getitm2 as $itmm => $hp_getitm2) { ?>
                                                <div class="clearfix relative product-no-ranking border-collapsed-element percent-content-3">
                                                    ...
                                                    <div class="clearfix absolute name-product-no-ranking">
                                                        <p class="title-product clearfix full-width title-hover-black"><a href="product.php?product=<?php echo $hp_getitm2['itmid']; ?>"><?php echo $hp_getitm2['iname']; ?></a></p>
                                                        <p class="clearfix price-product">₹ <?php echo $hp_getitm2['iprice']; ?> </p>
                                                    </div>
                                                </div>
                                            <?php } ?>
