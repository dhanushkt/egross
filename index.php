                        ...
                        <div class="clearfix relative menu-slide clear-padding bottom-margin-default">
                            ...
                            <div class="clearfix menu-web relative">
                                <ul>
                                    ...
                                    <li><a href="#"><img src="lander_plugins/img/icon_mobile.png"
                                                alt="Icon Mobile & Tablet" />
                                            <p>Mobile & Tablet</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_electric.png"
                                                alt="Icon Electric Appliances" />
                                            <p>Electric Appliances</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_computer.png"
                                    ...
                                    <li><a href="#"><img src="lander_plugins/img/icon_health.png"
                                                alt="Icon Health & Beauty" />
                                            <p>Health & Beauty</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_mother.png"
                                                alt="Icon Mother & Baby" />
                                            <p>Mother & Baby</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_book.png"
                                                alt="Icon Books & Stationery" />
                                            <p>Books & Stationery</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_tablet.png"
                                                alt="Icon Home & Life" />
                                            <p>Home & Life</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_sport.png"
                                                alt="Icon Sports & Outdoors" />
                                            <p>Sports & Outdoors</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_auto.png"
                                                alt="Icon Auto & Moto" />
                                            <p>Auto & Moto</p>
                                        </a></li>
                                    <li><a href="#"><img src="lander_plugins/img/icon_voucher.png"
                        ...
                        <div class="row">
                            ...
                            <div class="clearfix title-box full-width bottom-margin-default border bg-white">
                                <div class="clearfix name-title-box title-hot-bg relative">
                                    <img src="lander_plugins/img/icon_percent.png" class="absolute"
                                        alt="Icon Hot Deals" />
                                    <p>New Products</p>
                                </div>
                                <div class="clearfix menu-title-box bold uppercase">
                                    <ul>
                                        ...
                                        ?>
                                        <li><a onclick="showBoxCateHomeByID('#new_product<?php echo $max; ?>','.good-deal-product')"
                                                href="javascript:;"><?php echo $hp_getcat1['mcname']; ?></a></li>
                                            ...
                                            <div class=" product-son ">
                                                <div class="clearfix image-product relative animate-default">
                                                    <div class="center-vertical-image">
                                                        <img src="uploads/item/<?php echo $hp_getitm1['iimg']; ?>"
                                                            alt="Product . . ." />
                                                    </div>
                                                    <ul class="option-product animate-default">
                                                        ...
                                                        <?php } else { ?>
                                                        <li class="relative"><a class="wishlistItem"
                                                                data-id="<?php echo $hp_getitm1['itmid']; ?>"
                                                                href="javascript:void(0)"><i
                                                                    class="data-icondata-icon-basic icon-basic-heart"
                                                ...
                                                <p
                                                    class="title-product clearfix full-width title-hover-black animate-default">
                                                    <a class="animate-default"
                                                        href="product.php?product=<?php echo $hp_getitm1['itmid']; ?>"><?php echo $hp_getitm1['iname']; ?></a>
                                                </p>
                            ...
                            <div class=" clearfix content-left col-md-6 col-sm-6" style="padding-top: 20px !important">
                                ...
                                <div class="clearfix title-box full-width border">
                                    ...
                                    <div class="clearfix menu-title-box">
                                        <p class="view-all-product-category title-hover-red"><a
                                                href="view-category.php?id=<?php echo $hp_getmcat2['mcid']; ?>"
                                                class="animate-default">view all</a></p>
                                    </div>
                                </div>
                                ...
                                <div class="clearfix product-percent-content border-collapsed-box full-width">
                                    ...
                                    <div
                                        class="clearfix relative product-no-ranking border-collapsed-element percent-content-3">
                                        <div class="effect-hover-zoom center-vertical-image">
                                            <img src="uploads/item/<?php echo $hp_getitm2['iimg']; ?>"
                                                alt="Product Image . . .">
                                        ...
                                        <div class="clearfix absolute name-product-no-ranking">
                                            <div class="text">
                                                <p class="title-product clearfix full-width title-hover-black"><a
                                                        href="product.php?product=<?php echo $hp_getitm2['itmid']; ?>"><?php echo $hp_getitm2['iname']; ?></a>
                                                </p>
                    ...
                    <div class=" container border top-padding-default bottom-padding-default">
                        <div class="row">
                            <div class=" support-box-info relative col-md-3 col-sm-3 col-xs-6">
                                <img src="lander_plugins/img/icon_free_ship.png" alt="Icon Free Ship"
                                    class="absolute" />
                                <p>free shipping</p>
                            ...
                            <div class=" support-box-info relative col-md-3 col-sm-3 col-xs-6">
                                <img src="lander_plugins/img/icon_phone_big.png" alt="Icon Phone Tablet"
                                    class="absolute">
                                <p>contact with us</p>
                                <p>+07 (0) 7782 9137</p>
                            </div>
