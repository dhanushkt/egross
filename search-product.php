													...
													<?php if ($userlogin) { ?>
														...
														<?php if ($wishlist) { ?>
															<li class="relative"><a href="javascript:void(0)">
																	<i style="color: red" class="fa fa-plus Click-here" data-id="<?php echo $itemdata['itmid']; ?>" data-item="<?php echo $itemdata['iname']; ?>" aria-hidden="true"></i>
																</a></li>
														<?php } else { ?>
															<li class="relative"><a class="wishlistItem" href="javascript:void(0)"><i class="fa fa-plus Click-here" data-id="<?php echo $itemdata['itmid']; ?>" data-item="<?php echo $itemdata['iname']; ?>" aria-hidden="true"></i></a></li>
														<?php } ?>
