...
CREATE TABLE `mcat` (
  ...
  `mcactive` varchar(50) NOT NULL,
  `mcdesc` varchar(100) NOT NULL,
  `mcimg` varchar(100) NOT NULL,
  `mcimgdesc` varchar(100) NOT NULL
...
--
ALTER TABLE `mcat`
  MODIFY `mcid` int(10) NOT NULL AUTO_INCREMENT;
COMMIT;
