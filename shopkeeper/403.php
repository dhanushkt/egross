...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-wrapper">
            <div class="page-wrapper-inner" style="padding-top: 100px">
                ...
                <div class="page-content">
                    <div class="container-fluid"> 
                        <div class="d-none d-sm-inline-block" style="padding-top: 100px"></div>
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-5 p-0 align-self-center">
                                                <img src="../admin_plugins/images/server-error.svg" alt="" class="img-fluid">
                                            </div>
                                            <div class="col-md-7">
