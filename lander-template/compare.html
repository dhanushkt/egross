				...
				<div class="row">
					<div class="breadcrumb-web">
						<ul class="clear-margin">
							...
							<li class="animate-default title-hover-red"><a href="#">Compare</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<table class="compare-table">
							<tbody>
								...
								<tr>
									...
									<td><p>Wayfarer Messenger Bag</p></td>
									<td><p>Wayfarer Messenger Bag5</p></td>
								</tr>
								<tr>
									<td><p>Rating</p></td>
									<td>
										<div class="box-rank-modal">
											...
											<p class="count-review-modal left-margin-15-default">(4 reviews)</p>
										</div>
									</td>
									<td>
										<div class="box-rank-modal">
								...
								<tr>
									...
									<td><p>Vestibulum eu odio. Suspendisse potenti. Morbi mollis tellus ac sapien. Praesent egestas tristique nibh. Nullam dictum felis eu pede mollis pretium. Fusce egestas elit eget lorem. In auctor lobortis lacus.</p></td>
									<td><p>Vestibulum eu odio. Suspendisse potenti. Morbi mollis tellus ac sapien. Praesent egestas tristique nibh. Nullam dictum felis eu pede mollis pretium. Fusce egestas elit eget lorem. In auctor lobortis lacus.</p></td>
									<td><p>Vestibulum eu odio. Suspendisse potenti. Morbi mollis tellus ac sapien. Praesent egestas tristique nibh. Nullam dictum felis eu pede mollis pretium. Fusce egestas elit eget lorem. In auctor lobortis lacus.</p></td>
								</tr>
								<tr>
									...
									<td>
										<div class="action-compare">
											<a href="#" class="animate-default button-hover-red">Add to Cart</a>
