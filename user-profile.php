                ...
                <div class="container">
                    <div class="row relative">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 relative left-content-shoping clear-padding-left">
                            <center>
                                <div
                                    class="col-md-12 col-sm-12 col-xs-12 relative left-content-shoping clear-padding-left">
                                    <h1>ACCOUNT</h1>
                                </div>
                            </center>
                            ...
                            <div style="margin-top: 7%">
                                ...
                                <div class="form-input full-width clearfix relative">
                                    <button class="but"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</button>
                                    <button class="but"><i class="fa fa-check" aria-hidden="true"></i> Done</button>
                                </div>
                            </div>
                            ...
                            <div>
                                <div style="margin-top: 7%">
                                    ...
                                    <div class="form-input full-width clearfix relative">
                                        <button class="but"><i class="fa fa-pencil" aria-hidden="true"></i> Manage Address</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div style="margin-top: 7%">
                                    ...
                                    <div class="form-input full-width clearfix relative">
                                        ...
                                        <button class="but"><i class="fa fa-refresh" aria-hidden="true"></i> Change</button>
                                    </div>
                                </div>
                            </div>
