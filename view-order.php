			...
			<div class="container">
				<div class="row relative">
                    ...
                    <div class="col-md-6 col-lg-6 relative left-content-shoping clear-padding-left">
                        <div class="row">
							<div class="col-md-10"
                            	style="height: 250px; padding:15px; word-wrap: break-word;">
					...
					<div class="row">
						<div class="col-md-2 relative justify-content form-login-checkout">
							<button type="submit" class="animate-default button-hover-red" style="margin-bottom:10%" name="register">REGISTER</button>
						</div>
					</div>
