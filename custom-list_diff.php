...
if(true){
    echo "<script>window.location.href='custom-item.php'; </script>";
}

/* Add List code here*/
if (isset($_POST['btnsaveList'])) {

    //ceck if list name is empty
    if (empty($_POST['clist']) || empty($_POST['clistMob'])) {
        $fmsg = "Enter aa Custom List Name";
    } else {
                                ...
                                <form method="POST">
                                    <div class="relative full-width product-in-cart border no-border-l no-border-r overfollow-hidden customHoverRow" id="addList" style="display: none;">
                                        ...
                                        <div class=" mobile col-md-12 product-in-cart-col-2">
                                            ...
                                            <hr>
                                            <input type="text" placeholder="Enter List Name" name="clist" class="form-text" />
                                            <div class="row">
                                                <div class="col-lg-6">
